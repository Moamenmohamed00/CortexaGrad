        ...
        private List<Doctor> CreateDoctors()
        {
            return new List<Doctor>
            {
                new()
                {
                    ...
                    PhoneNumbers = new List<string> { "+20-100-555-0001" },
                ...
                new()
                {
                    ...
                    PhoneNumbers = new List<string> { "+20-100-555-0002" },
                ...
                new()
                {
                    ...
                    PhoneNumbers = new List<string> { "+20-100-555-0003" },
                ...
                new()
                {
                    ...
                    PhoneNumbers = new List<string> { "+20-100-555-0004" },
        ...
        private List<Nurse> CreateNurses()
        {
            return new List<Nurse>
            {
                new()
                {
                    ...
                    PhoneNumbers = new List<string> { "+20-100-555-1001" },
                    Shift = ShiftType.Morning,
                ...
                new()
                {
                    ...
                    PhoneNumbers = new List<string> { "+20-100-555-1002" },
                    Shift = ShiftType.Morning,
                ...
                new()
                {
                    ...
                    PhoneNumbers = new List<string> { "+20-100-555-1003" },
                    Shift = ShiftType.Evening,
                    Role = NurseRole.Staff,
                    Department = "Emergency"
                },
                new()
                {
                    ...
                    PhoneNumbers = new List<string> { "+20-100-555-1004" },
                    Shift = ShiftType.Night,
                    Role = NurseRole.Staff,
                    Department = "ICU"
                }
        ...
        private List<Patient> CreatePatients()
        {
            return new List<Patient>
            {
                new()
                {
                    ...
                    PhoneNumbers = new List<string> { "+20-101-000-0001" },
                ...
                new()
                {
                    ...
                    PhoneNumbers = new List<string> { "+20-101-000-0002" },
                ...
                new()
                {
                    ...
                    PhoneNumbers = new List<string> { "+20-101-000-0003" },
                ...
                new()
                {
                    ...
                    PhoneNumbers = new List<string> { "+20-101-000-0004" },
                ...
                new()
                {
                    ...
                    PhoneNumbers = new List<string> { "+20-101-000-0005" },
